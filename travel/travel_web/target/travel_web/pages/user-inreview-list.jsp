                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting">返回时间</th>
                                <th class="sorting">住宿费</th>
                                <th class="sorting">交通费</th>
                                <th class="sorting">餐饮费</th>
                                <th class="sorting">其他费用</th>
                                <th class="sorting">其他费用备注</th>
                                <th class="sorting">共计</th>
                                <th class="sorting">审核状态</th>
                                <th class="sorting">完成状态</th>
