...
<aside class="main-sidebar">
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<li id="admin-index"><a
				href="${pageContext.request.contextPath}/pages/accountant-main.jsp><i
					class="fa fa-dashboard"></i> <span>首页</span></a></li>

			<li class="treeview"><a href="#"> <i class="fa fa-cogs"></i>
					<span>申请管理</span> <span class="pull-right-container"> <i
				...
				<ul class="treeview-menu">
					...
					<li id="system-login"><a
							href="${pageContext.request.contextPath}/Apply/findAudit"> <i
							class="fa fa-circle-o"></i> 待审核
					</a>
					</li>
					<li id="system-login"><a
							href="${pageContext.request.contextPath}/User/findAll"> <i
							class="fa fa-circle-o"></i> 未通过
					</a>
					<li id="system-login"><a
							href="${pageContext.request.contextPath}/User/findAll"> <i
